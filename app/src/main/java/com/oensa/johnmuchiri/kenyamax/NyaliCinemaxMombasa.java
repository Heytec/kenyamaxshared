...
public class NyaliCinemaxMombasa extends ActionBarActivity {
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/nyali_cinemax/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nyali_cinemax_mombasa);
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(NyaliCinemaxMombasa.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KeysNyali.EndpointBoxOffice.KEY_MOVIES);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nyali_cinemax_mombasa, menu);
        return true;
    }
