...
public class PlanetMediaKisumu extends ActionBarActivity {
    Toolbar toolbar;
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/planet_media/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planet_media_kisumu);
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(PlanetMediaKisumu.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KeysPlanetMediaKisumu.EndpointBoxOffice.KEY_MOVIES);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_planet_media_kisumu, menu);
        return true;
    }
