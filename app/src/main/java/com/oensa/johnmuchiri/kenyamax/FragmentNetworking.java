...
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_CATEGORY;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_DESCRIPTION;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_ENDING_DATE;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_ID;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_LOCATION;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_POSTER;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_PRICE;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_NETWORKING;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_STARTING_DATE;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_TIME;
import static com.oensa.johnmuchiri.kenyamax.KeysNetwork.EndpointBoxOffice.KEY_TITLE;


/**
 * A simple {@link Fragment} subclass.
 * Use the {@link FragmentNetworking#newInstance} factory method to
...
public class FragmentNetworking extends Fragment {
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v3/index.php/events/networking/?key=850b17f83631daf62ec8ff3e7214b753";
     ...
     * @return A new instance of fragment FragmentNetworking.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentNetworking newInstance(String param1, String param2) {
        FragmentNetworking fragment = new FragmentNetworking();
    ...
    private  ArrayList<EventFreeModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KEY_NETWORKING);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fragment_networking, container, false);
