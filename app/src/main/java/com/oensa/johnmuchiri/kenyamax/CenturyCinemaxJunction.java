...
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_MOVIES;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_TITLE;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_YEAR;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_GENRE;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_SYNOPSIS;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_ACTORS;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_RATINGS;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_VOTES;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_POSTERS;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_TIME_SHOWING;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_MONDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_TUESDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_WENESDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_THURSDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_FRIDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_SATARDAY;
import static com.oensa.johnmuchiri.kenyamax.KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_SUNDAY;


public class CenturyCinemaxJunction extends ActionBarActivity {
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/century_cinemax/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_century_cinemax_junction);
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(CenturyCinemaxJunction.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KeysCenturycinemaxjuction.EndpointBoxOffice.KEY_MOVIES);
            for (int i = 0; i < arrayGigs.length(); i++) {
                ...
                //data.append(id + "\n");
                //String id= currentGigs.getString(KEY_ID);
                String title= currentGigs.getString(KeysMovieTheatre.EndpointBoxOffice.KEY_TITLE);
                String year= currentGigs.getString(KeysMovieTheatre.EndpointBoxOffice.KEY_YEAR);
                String genre= currentGigs.getString(KeysMovieTheatre.EndpointBoxOffice.KEY_GENRE);
                String synopsis= currentGigs.getString(KeysMovieTheatre.EndpointBoxOffice.KEY_SYNOPSIS);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_century_cinemax_junction, menu);
        return true;
    }
