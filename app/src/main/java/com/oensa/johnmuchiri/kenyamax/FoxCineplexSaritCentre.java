...
public class FoxCineplexSaritCentre extends ActionBarActivity {
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/fox/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fox_cineplex_sarit_centre);
       ...
       // toolbar.getBackground().setAlpha(0);
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(FoxCineplexSaritCentre.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KeysFoxCinema.EndpointBoxOffice.KEY_MOVIES);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_fox_cineplex_sarit_centre, menu);
        return true;
    }
