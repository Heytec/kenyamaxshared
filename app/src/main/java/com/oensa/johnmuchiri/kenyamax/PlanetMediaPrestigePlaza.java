...
import static com.oensa.johnmuchiri.kenyamax.KeysMovieTheatre.EndpointBoxOffice.KEY_MOVIES;
...
public class PlanetMediaPrestigePlaza extends ActionBarActivity {
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/planet_media_prestige/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planet_media_prestige_plaza);
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(PlanetMediaPrestigePlaza.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KeysPlanetmediaPrestigePlaza.EndpointBoxOffice.KEY_MOVIES);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_planet_media_prestige_plaza, menu);
        return true;
    }
