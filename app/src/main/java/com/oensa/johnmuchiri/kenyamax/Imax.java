...
public class Imax extends ActionBarActivity {
    Toolbar toolbar;
    ...
    public static final String URL_FREE="http://kenyamax.oensa.com/v4/index.php/imax/?key=$2y$10$5ebdde1aedb51ab740332uwVI2O";
   ...
   public static final String MOVIE_TRANSFER_KENYA="EVENT_TRANSFER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMovieHits.addOnItemTouchListener(new RecyclerTouchListener(this, listMovieHits, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent intent = new Intent(Imax.this,KenyaMovieTheatreDetails.class);
    ...
    private  ArrayList<MovieTheatreModel> parseJSONResponse(JSONObject response) {
        ...
        try {
            ...
            JSONArray arrayGigs = response.getJSONArray(KEY_MOVIES);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_imax, menu);
        return true;
    }
