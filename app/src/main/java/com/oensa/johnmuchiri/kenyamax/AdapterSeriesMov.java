 ...
 */
public class AdapterSeriesMov extends RecyclerView.Adapter<AdapterSeriesMov.ViewHolderEvent> {

    private ArrayList<PopUpTvmoviemodel> listEvent=new ArrayList<>();
    private LayoutInflater layoutInflater;
    private VolleySingleton volleySingleton;
    private ImageLoader imageLoader;


    public AdapterSeriesMov(Context context) {
        layoutInflater = LayoutInflater.from(context);
        volleySingleton= VolleySingleton.getInstance();
        imageLoader=volleySingleton.getImageLoader();

    }
    public void setMovieList(ArrayList<PopUpTvmoviemodel> listEvent){
    ...
    @Override
    public void onBindViewHolder(final AdapterSeriesMov.ViewHolderEvent holder, int position) {
        PopUpTvmoviemodel currentEvent=listEvent.get(position);
    ...
    public PopUpTvmoviemodel getEventKenya(int position){
    ...
    public void setevents(ArrayList<PopUpTvmoviemodel> listEvent){
        this.listEvent=listEvent;
